...
\begin{tikzpicture}
		...
		\draw [thick,decoration={brace,mirror,raise=0.5cm},decorate] (xl.west) -- (xtildel.east) node [pos=0.5,anchor=north,yshift=-0.55cm] {Vektory příznaků instancí}; 

		\draw [thick,decoration={brace,mirror,raise=0.5cm},decorate] (g.east) -- (f.east) node [pos=0.5,anchor=north,yshift=-0.55cm] {Vektory příznaků tašek}; 
\end{tikzpicture}
